...
4. 과거 썰: 조직의 노선·역사, 정책 어젠다의 역사적 기원, 사건 자체의 타임라인·경위. (신호: 과거로 거슬러 올라가야 이해되는 상황, 장기 진행형 이슈)
   ...
   정황, 현재 발견/해결 여부)를 먼저 web_search로 확인해 담는다. 검색해도 개인정보 보호 등으로
   구체적 내용이 공개되지 않았다면 그 사실 자체를("실종 경위는 아직 자세히 공개되지 않음")
   명시하고, 파생 이슈로 이 축을 대체하지 않는다 — 필요하면 파생 이슈는 별도 축으로 다룬다.
